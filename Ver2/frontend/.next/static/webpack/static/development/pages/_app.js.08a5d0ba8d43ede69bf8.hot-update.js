...
function addCommentAPI(data) {
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/post/".concat(data.postId, "/comment"), {
...
function loadMainPostsAPI() {
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('/posts'); // 게시글을 보는정도의 api는 크리덴셜 안넣어줘도 무방
}
...
function loadUserPostsAPI(id) {
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/user/".concat(id, "/posts")); // 게시글을 보는정도의 api는 크리덴셜 안넣어줘도 무방
}
...
function loadCommentsAPI(postId) {
  ...
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.post("/post/".concat(postId, "/comments"));
}
...
//# sourceMappingURL=_app.js.08a5d0ba8d43ede69bf8.hot-update.js.map