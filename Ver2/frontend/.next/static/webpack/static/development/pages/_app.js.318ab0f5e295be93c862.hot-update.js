...
function loadMainPostsAPI() {
  ...
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/posts?lastId=".concat(lastId, "&limit=").concat(limit)); // 게시글을 보는정도의 api는 크리덴셜 안넣어줘도 무방
}
...
function loadHashtagPostsAPI(tag, lastId) {
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/hashtag/".concat(encodeURIComponent(tag), "?lastId=").concat(lastId, "&limit=10")); //주소에 한글이 들어가면 에러가 날 수 있음
...
function loadUserPostsAPI(id) {
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.get("/user/".concat(id || 0, "/posts")); // 게시글을 보는정도의 api는 크리덴셜 안넣어줘도 무방
}
  ...
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function loadPost$(_context23) {
    while (1) {
      switch (_context23.prev = _context23.next) {
        ...
        case 12:
          alert(_context23.t0.response && _context23.t0.response.data);
...
//# sourceMappingURL=_app.js.318ab0f5e295be93c862.hot-update.js.map